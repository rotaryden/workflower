...
// Client handles OpenRouter API communication
type Client struct {
	apiKey     string
	model      string
	baseURL    string
...
// WithSiteInfo sets optional site information for OpenRouter
func (c *Client) WithSiteInfo(siteURL, siteName string) *Client {
	c.siteURL = siteURL
	c.siteName = siteName
	return c
}
...
// ChatRequest represents the OpenRouter chat completion request
